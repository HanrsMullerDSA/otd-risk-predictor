...
GEOJSON_URL = (
    ...
    "/master/arquivos_geoespaciais/unidades_da_federacao.json"
)
...
|---|---|
| Threshold ótimo | {THRESHOLD*100:.2f}% |
| Prior global de atraso | {PRIOR_GLOBAL*100:.2f}% |
| Taxa base (treino) | 7,59% |
| Taxa base (teste) | 3,49% |
| Versão do modelo | v{MODEL_VERSION} |
        """)
